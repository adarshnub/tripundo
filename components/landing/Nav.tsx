      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-8 py-4">
        <div className="flex items-center justify-between rounded-2xl border border-white/30 bg-white/50 backdrop-blur-xl px-4 py-2.5 shadow-lg shadow-emerald-900/10">
          ...
          <div className="flex items-center gap-2">
            <Button asChild variant="ghost" className="hidden sm:inline-flex text-emerald-950/80 hover:bg-emerald-900/10">
              <Link href="/auth">Sign in</Link>
            </Button>
            <Button asChild className="bg-emerald-950 text-white hover:bg-emerald-900 font-medium rounded-full px-4 shadow-md">
